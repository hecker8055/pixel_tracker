import k from "fetch-ponyfill";
import U from "form-data";
import { createMachine as M, assign as c, spawn as b, send as A, actions as C } from "xstate";
  ...
  return new Promise((u) => {
    ...
    n.responseType = "json", n.onload = () => {
      ...
      if (n.status < 200 || n.status >= 300) {
        const H = {
          error: (F = (S = (f = (p = n.response) == null ? void 0 : p.error) == null ? void 0 : f.message) != null ? S : (T = n.response) == null ? void 0 : T.error) != null ? F : n.response,
          message: (x = (_ = (R = n.response) == null ? void 0 : R.error) == null ? void 0 : _.message) != null ? x : n.response,
          status: n.status
        };
        return u({
          fileMetadata: null,
...
class q {
  constructor({ url: e, adminSecret: r }) {
    this.url = e, this.api = new $({ url: e }), this.setAdminSecret(r);
  }
  async upload(e) {
...
export {
  $ as HasuraStorageApi,
  q as HasuraStorageClient,
  O as INITIAL_FILE_CONTEXT,
  E as appendImageTransformationParameters,
  N as createFileUploadMachine,
  X as createMultipleFilesUploadMachine,
  B as uploadFilePromise,
  V as uploadMultipleFilesPromise
};
